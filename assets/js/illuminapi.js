...
self.onmessage = async function(event) {
    ...
    try {
        ...
        const defaultApiParameters = {
            ...
            instructions: llmSettings.instructions,
            max_output_tokens: llmSettings.max_output_tokens || 100000,
            reasoning: {
        ...
        console.log('Worker: Making API call to Fireworks responses API with payload:', finalApiPayload);
        ...
        const choice = apiData.output // responses text
